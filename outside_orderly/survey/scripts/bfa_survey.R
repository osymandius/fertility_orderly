...
# bfa2021dhs_boundaries <- read_sf("outside_orderly/survey/survey-bits/BFA2021DHS boundaries/shps/sdr_subnational_boundaries.shp")
# 
# bfa2021dhs_boundaries <- bfa2021dhs_boundaries %>%
#   mutate(survey_id = "BFA2021DHS") %>%
#   select(survey_id,
...
#   bind_rows(bfa2021dhs_boundaries)
