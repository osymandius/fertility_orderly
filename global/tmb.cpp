  ...
  
{
  ...
  // vector<Type> var_nbinom_naomi = exp(mu_obs_pred_naomi) + ((exp(mu_obs_pred_naomi)) * (exp(mu_obs_pred_naomi)) * overdispersion);
  ...
  // nll -= dnbinom2(births_obs_naomi, exp(mu_obs_pred_naomi), var_nbinom_naomi, true).sum();  
