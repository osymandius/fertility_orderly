  ...
  
{
  ...
  DATA_SPARSE_MATRIX(R_spatial_admin1);
  ...
  nll += SEPARABLE(AR1(Type(eta2_phi_period)), GMRF(R_spatial_admin1))(eta2);
  ...
  nll += SEPARABLE(AR1(Type(eta3_phi_age)), GMRF(R_spatial_admin1))(eta3);
