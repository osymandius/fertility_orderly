...
population <- read.csv("archive/zwe_data_population/20201130-162514-ea8350d2/zwe_population_nso.csv")
areas <- read_sf("archive/zwe_data_areas/20201103-094144-94388ee2/zwe_areas.geojson")
asfr <- read.csv("archive/zwe_asfr/20201203-175137-77e29f2b/zwe_dhs_asfr.csv")
# asfr <- readRDS("~/Documents/GitHub/subnat_fertility/countries/ZWE/data/ZWE_asfr_admin1.rds")
...
fr_plot <- read.csv("archive/zwe_asfr/20201203-175137-77e29f2b/zwe_fr_plot.csv") %>%
