...
dhs_asfr <- read.csv(paste0("depends/", tolower(iso3), "_asfr.csv"))
mics_asfr <- read.csv(paste0("depends/", tolower(iso3), "_mics_asfr.csv"))

plot_dat <- bind_rows(
  read.csv(paste0("depends/", tolower(iso3), "_plot.csv")),
  read.csv(paste0("depends/", tolower(iso3), "_mics_plot.csv"))
)
