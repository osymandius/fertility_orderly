...
clusters <- read.csv("depends/MOZ_dhs_survey.csv")
...
write_csv(asfr, "MOZ_dhs_asfr.csv")

mics_dat <- read.csv("depends/MOZ_mics_dat.csv")
...
write_csv(mics_asfr, "MOZ_mics_asfr.csv")