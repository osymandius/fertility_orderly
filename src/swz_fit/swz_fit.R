...
population <- read.csv("archive/swz_data_population/20201130-150332-bd7e6821/swz_world_pop_for_naomi.csv")
areas <- read_sf("archive/swz_data_areas/20201130-150303-0fe9325c/swz_areas.geojson")
asfr <- read.csv("archive/swz_asfr/20201203-174002-8fef11ee/swz_asfr.csv")
...
tmb_results %>%
  filter(area_level == 1, variable == "tfr", str_detect(area_id, "MOZ")) %>%
...
fr_plot <- read.csv("archive/swz_asfr/20201203-174002-8fef11ee/swz_fr_plot.csv") %>%
  filter(variable == "tfr") %>%
