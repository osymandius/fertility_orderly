...
areas <- read_sf("archive/moz_data_areas/20201112-144347-48e53ce9/moz_areas.geojson")
asfr <- read.csv("archive/moz_asfr/20201204-141436-7f9b7a9d/moz_asfr.csv")
...
fr_plot <- read.csv("archive/moz_asfr/20201204-141436-7f9b7a9d/moz_fr_plot.csv") %>%
  filter(variable == "tfr") %>%
