...
# TMB::compile("~/Documents/GitHub/dfertility/src/model6_mwi_rwa.cpp", flags = "-w")               # Compile the C++ file
# TMB::compile("no_tips.cpp", flags = "-w")               # Compile the C++ file
# dyn.load(dynlib("~/Documents/GitHub/dfertility/src/model6_mwi_rwa"))
