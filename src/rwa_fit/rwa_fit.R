...
population <- read.csv("archive/rwa_data_population/20201130-145722-296bcdf9/rwa_population.csv")
areas <- read_sf("archive/rwa_data_areas/20201116-110250-98e9bc09/rwa_areas.geojson")
asfr <- read.csv("archive/rwa_asfr/20201203-173655-d59fe41c/rwa_dhs_asfr.csv")
...
fr_plot <- read.csv("archive/rwa_asfr/20201203-173655-d59fe41c/rwa_fr_plot.csv") %>%
  left_join(areas %>% st_drop_geometry() %>% select(area_id, area_name)) %>%
  filter(variable == "tfr") %>%
  select(area_id, area_name, period, value)
