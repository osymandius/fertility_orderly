...
areas <- read_sf("archive/nam_data_areas/20201116-081017-f96d9e96/nam_areas.geojson")
...
fr_plot <- read.csv("archive/nam_asfr/20201203-173514-66f3cc83/nam_fr_plot.csv") %>%
  filter(variable == "tfr") %>%
